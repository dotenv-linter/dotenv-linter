...
mod tests {
    ...
    fn warning_fmt_test() {
        ...
        let warning = Warning::new(line, String::from("DuplicatedKey: The FOO key is duplicated"));

        assert_eq!(".env:1 DuplicatedKey: The FOO key is duplicated", format!("{}", warning));
    }
