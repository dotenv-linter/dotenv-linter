...
### 🔧 Changed
- Add `LineEntry.is_empty_or_comment` method to DRY and simplify `Check.run`. [#93](https://github.com/mgrachev/dotenv-linter/pull/93) ([@Aleksey Glukhov](https://github.com/pineapplethief))
